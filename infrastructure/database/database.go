...
func AutoMigrate(db *gorm.DB) error {
	// Set up the custom join table for Storyboard and Characters to include OutfitID
	err := db.SetupJoinTable(&models.Storyboard{}, "Characters", &models.StoryboardCharacter{})
	if err != nil {
