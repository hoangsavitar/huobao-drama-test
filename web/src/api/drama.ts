...
export const dramaAPI = {
  ...
  generateNarrativeEpisodes(id: string, data: { user_idea: string; agent_step?: number }) {
    return request.post<{ task_id: string; message: string }>(`/dramas/${id}/narrative/generate`, data)
  },
